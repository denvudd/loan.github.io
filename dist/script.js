...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "checkPhoneInputs",
    value: function checkPhoneInputs() {
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggers, popup) {
  ...
  _createClass(VideoPlayer, [{
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          if (document.querySelector('iframe#videoframe')) {
            ...
            _this.popup.classList.remove('fadeOut');

            _this.popup.classList.add('animated', 'fadeInDown');
          } else {
    ...
    value: function bindCloseTrigger() {
      var _this2 = this;

      this.close.addEventListener('click', function () {
        _this2.popup.style.display = 'none';

        _this2.popup.classList.remove('fadeInDown');

        _this2.player.stopVideo();

        _this2.player.clearVideo();
      });
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function prevSlide() {
      var active = this.slides[this.slides.length - 1];
